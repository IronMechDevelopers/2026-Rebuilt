...
public class MAXSwerveModule {
  ...
  public void setDesiredState(SwerveModuleState desiredState) {
    ...
    drivingController.setReference(correctedDesiredState.speedMetersPerSecond, ControlType.kVelocity);
    turningController.setReference(correctedDesiredState.angle.getRadians(), ControlType.kPosition);
  ...
  public void setBrakeMode(boolean shouldBrake) {
    ...
    drivingSpark.configure(drivingConfig, ResetMode.kNoResetSafeParameters, PersistMode.kNoPersistParameters);

    // Create config and set idle mode for turning motor
    SparkMaxConfig turningConfig = new SparkMaxConfig();
    turningConfig.idleMode(mode);
    turningSpark.configure(turningConfig, ResetMode.kNoResetSafeParameters, PersistMode.kNoPersistParameters);
  }
}
